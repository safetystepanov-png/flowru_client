...
class _ClientPreorderScreenState extends State<ClientPreorderScreen>
  ...
  Widget _heroCard() {
    return AnimatedBuilder(
      animation: _motion,
      builder: (context, child) {
        final glow = 0.17 + (_motion.value * 0.10);
        return Container(
          width: double.infinity,
          padding: const EdgeInsets.all(22),
          decoration: BoxDecoration(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                _featureType == 'appointment'
                    ? 'Опишите услугу и удобное время — сотрудник подтвердит запись.'
                    : 'Соберите заказ за пару секунд: описание, время и способ оплаты.',
                style: TextStyle(
                ...
                Row(
                  children: [
                    AnimatedBuilder(
                      animation: _motion,
                      builder: (context, child) {
                        final scale = 1.0 + (_motion.value * 0.030);
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, size: 20, color: selected ? Colors.white : _soft),
              const SizedBox(width: 8),
              Flexible(
                child: Text(
                  label,
  ...
  Widget _formCard() {
    final buttonLabel = _sending ? 'Отправляем...' : _submitLabel;
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                if (_allowAsap) _timeButton('Как можно скорее', 'asap', 0),
